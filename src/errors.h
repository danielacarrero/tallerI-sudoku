...
/* PROGRAM INVOCATION */
#define MSG_ERROR_PROGRAM_INVOCATION "Modo no soportado, \
...
/* COMMAND INVOCATION */
#define MSG_ERROR_UNSUPPORTED_INDICES "Error en los índices. \
Rango soportado: [1,9]\n"
#define MSG_ERROR_UNSUPPORTED_VALUE "Error en el valor ingresado. \
Rango soportado: [1,9]\n"
...
#define MSG_ERROR_SOCKET_BINDING_AND_LISTEN "Error al establecer \
